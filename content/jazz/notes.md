...
Imaginons que nous partons d’une note fondamentale, Do 4, qui a une fréquence de 440 Hz (c'est la note de concert, souvent appelée "la de concert").

Lorsque l'on monte d'un demi-ton, la fréquence de la note suivante sera multipliée par un facteur de $$ \sqrt{2} $$ ou 1.05946.


*Exemple : Calcul des fréquences pour les demi-tons*

- Do 4 (440 Hz)
    C'est notre fréquence de départ, donc f_0 = 440 Hz.

- Si l'on monte d’un demi-ton à Do# 4 (Do dièse), la fréquence est :

$f_{\text{Do\#4}} = 440 \times 1.05946 = 466.16 \, \text{Hz}$


   Si on monte encore d’un autre demi-ton à Ré 4, la fréquence est :
    fReˊ4=466.16×1.05946=493.88 Hz
    fReˊ4​=466.16×1.05946=493.88Hz
...
Si l'on part de Do 4 à 440 Hz, une octave plus haute sera Do 5 :
fDo 5=440×2=880 Hz
fDo 5​=440×2=880Hz
...
Une **octave** est l’ensemble de 12 notes (7 blanches et 5 noires), et à partir de la **note Do** jusqu'à la suivante **note Do** plus aiguë ou plus grave. Quand tu montes ou descends d’une octave, tu passes par toutes les 12 notes, mais tu les retrouves à un niveau plus haut ou plus bas.
...
Si Do 4 a une fréquence de 440 Hz, la fréquence de Sol 4 (une quinte juste au-dessus de Do 4) sera :
fSol4=440×32=660 Hz
fSol4​=440×23​=660Hz

C'est ainsi que l'intervalle de quinte juste se construit mathématiquement.
3. La gamme majeure et ses rapports
...
Les rapports de fréquence entre ces notes sont les suivants :
 ...
 - Do - Ré : 9:89:8 (un ton)
 - Ré - Mi : 5:45:4 (un ton)
 - Mi - Fa : 4:34:3 (un demi-ton)
 - Fa - Sol : 9:89:8 (un ton)
 - Sol - La : 9:89:8 (un ton)
 - La - Si : 9:89:8 (un ton)
 - Si - Do : 16:1516:15 (un demi-ton)

> La notation 2:1 se prononce en général "deux pour un".

Exemple : Calcul de Sol 4 à partir de Do 4

On veut calculer la fréquence de Sol 4 à partir de Do 4 (qui est 440 Hz), en utilisant les rapports.

   - Do 4 à Ré 4 (rapport 9:8) :
    fRe4 = 440 × 9/8 =495 Hz

   - Ré 4 à Mi 4 (rapport 5:4) :
    fMi 4=495×5/4=618.75Hz

   - Mi 4 à Fa 4 (rapport 4:3) :
    fFa 4=618.75×43=825 Hz
    fFa 4​=618.75×34​=825Hz

   - Fa 4 à Sol 4 (rapport 9:8) :
    fSol 4=825×98=926.25 Hz
    fSol 4​=825×89​=926.25Hz

Ainsi, Sol 4 aurait une fréquence d'environ 926.25 Hz.
...
Intervalle de demi-ton=21/12≈1.05946
Intervalle de demi-ton=21/12≈1.05946
Exemple : Calcul des fréquences pour les 12 notes dans une octave

Si Do 4 est à 440 Hz, voici les fréquences des 12 notes successives :

   Do 4 : 440 Hz
   Do# 4 : 440×1.05946=466.16Hz 
   Ré 4 : 466.16×1.05946=493.88Hz 
   Ré# 4 : 493.88×1.05946=523.25Hz 
   Mi 4 : 523.25×1.05946=554.37Hz
   Fa 4 : 554.37×1.05946=587.33Hz
   Fa# 4 : 587.33×1.05946=622.25Hz
   Sol 4 : 622.25×1.05946=659.25Hz
   Sol# 4 : 659.25×1.05946=698.46Hz
   La 4 : 698.46×1.05946=739.99Hz
   La# 4 : 739.99×1.05946=783.99Hz
   Si 4 : 783.99×1.05946=830.61Hz
   Do 5 : 830.61×1.05946=880Hz
